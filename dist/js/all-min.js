...
exports.Ejercicio = exports.EjercicioService = undefined;
...
exports.renderizarFormulario = renderizarFormulario;
...
var urlEjercicios = "http://localhost:8080/gestiongimnasio/api/ejercicios";

//Clase publica que extiende de GenericService

var EjercicioService = exports.EjercicioService = function (_service$GenericServi) {
    _inherits(EjercicioService, _service$GenericServi);

    function EjercicioService() {
        _classCallCheck(this, EjercicioService);

        return _possibleConstructorReturn(this, (EjercicioService.__proto__ || Object.getPrototypeOf(EjercicioService)).call(this));
    }

    _createClass(EjercicioService, [{
        key: "getAll",
        value: function getAll() {
            //Devolvemos una promesa para recoger los datos y no perderlos
            return _get(EjercicioService.prototype.__proto__ || Object.getPrototypeOf(EjercicioService.prototype), "ajax", this).call(this, urlEjercicios, "get", null, "text");
        }
    }, {
        key: "getById",
        value: function getById(codigo) {
            //Devolvemos una promesa para recoger los datos y no perderlos
            return _get(EjercicioService.prototype.__proto__ || Object.getPrototypeOf(EjercicioService.prototype), "ajax", this).call(this, urlEjercicios + "/" + codigo, "get", null, "text");
        }
    }, {
        key: "delete",
        value: function _delete(codigo) {
            return _get(EjercicioService.prototype.__proto__ || Object.getPrototypeOf(EjercicioService.prototype), "ajax", this).call(this, urlEjercicios + "/" + codigo, "delete", null, "text");
        }
    }, {
        key: "create",
        value: function create(ejercicio) {
            return _get(EjercicioService.prototype.__proto__ || Object.getPrototypeOf(EjercicioService.prototype), "ajax", this).call(this, urlEjercicios, "post", ejercicio, "json");
        }
    }]);
...
function renderizarFormulario() {
    ...
    var es = new EjercicioService();
    var ejercicio = new Ejercicio();
    var txt = "";
    return new Promise(function (resolve, reject) {
        if (codigo > -1 && codigo != null) {
            es.getById(codigo).then(function (ejer) {
...
function parseForm(ejercicio) {
    ...
    txt = "<input type='text' name='nombre'" + " id='nombre' value='" + ejercicio.nombre() + "'>";
...
function crearEjercicio(ejercicioJSON) {
    var es = new EjercicioService();
    return new Promise(function (resolve, reject) {
        es.create(ejercicioJSON).then(function (data) {
            console.log(data);
            resolve(data);
        }).catch(function (error) {
    ...
    return new Promise(function (resolve, reject) {
        eS.getAll().then(function (data) {
            ...
            if (ejercicios.length > 0) {
                txt = "<table data-table='ejercicios' id='tablaEjercicios' class='rwd-table'><thead><tr>" + "<th><input type='checkbox' name='borrartodos' id='borrartodos'/></th>" + "<th>Actividad</th>" + "<th>Grupo Muscular</th>" + "<th>Máquina</th>" + "<th>Descripción</th>" + "<th></th></tr></thead><tbody>";
...
function parseEjercicio(ejercicio) {
    var codigo = ejercicio.codigo;
    var actividad = ejercicio.actividad;
    var grupomuscular = ejercicio.grupomuscular;
    var maquina = ejercicio.maquina;
    var descripcion = ejercicio.description;
    var activo = ejercicio.activo;
    var htmlEdit = "<button>Editar</button>";
    var htmlDelete = "<button>Borrar</button>";

    var texto = "<tr>" + "<td><input type='checkbox' value='" + codigo + "'></td>" + "<td>" + actividad + "</td>" + "<td>" + grupomuscular + "</td>" + "<td>" + maquina + "</td>" + "<td>" + descripcion + "</td>" + "<td>" + activo + "</td>" + "<td>" + htmlEdit + htmlDelete + "</td>" + "</tr>";

    return texto;
}

var Ejercicio = exports.Ejercicio = function () {
    function Ejercicio() {
        _classCallCheck(this, Ejercicio);
    ...
    _createClass(Ejercicio, [{
        ...
        set: function set(musculargroup) {
...
},{"./genericservice":16,"jquery":14}],16:[function(require,module,exports){
"use strict";
...
var GenericService = exports.GenericService = function () {
    ...
    _createClass(GenericService, [{
        key: "ajax",
        value: function ajax(url, method, data, tipo) {
            return new Promise(function (resolve, reject) {
                $.ajax({
                    "url": url,
                    "data": data,
...
var ejercicio = _interopRequireWildcard(_ejercicios);

var _usuarios = require("./usuarios");

var usuario = _interopRequireWildcard(_usuarios);

var _validaciones = require("./validaciones");

var validaciones = _interopRequireWildcard(_validaciones);
...
var $listadoEjercicios = (0, _jquery2.default)("#listadoEjercicios");
var $listadoUsuarios = (0, _jquery2.default)("#listadoUsuarios");
var $contactForm = (0, _jquery2.default)("#contactForm");
var $pagebody = (0, _jquery2.default)("#page-body");

//Si existe listado de usuarios...
if ($listadoUsuarios.length) {
    //Coge el listado de usuarios
    var u1 = usuario.renderizar();
...
if ($listadoEjercicios.length) {
    ...
    var e1 = ejercicio.renderizar(); //Renderizar devuelve una promesa
...
function borrarVarios() {
    ...
    (0, _jquery2.default)("table tbody input:checked").each(function () {
...
(0, _jquery2.default)("#guardar").on("click", function () {
    //Parsea lo que obtenemos del formulario a JSON mediante serializeObject()
    var ejercicioJSON = JSON.stringify((0, _jquery2.default)("#formCrearEjercicio").serializeObject());
    ...
    var nuevoEjercicio = ejercicio.crearEjercicio(ejercicioJSON);
    nuevoEjercicio.then(function () {
        //Oculta el formulario
        (0, _jquery2.default)("#myModal").modal("hide");
        //Borra los campos del formulario
        (0, _jquery2.default)("#myModal")[0].reset();
    }).catch(function (error) {
        console.log(error);
    });
});
...
_jquery2.default.fn.serializeObject = function () {
    var obj = {};
    var array = this.serializeArray();
    _jquery2.default.each(array, function () {
...
},{"./ejercicios":15,"./usuarios":18,"./validaciones":19,"bootstrap":1,"jquery":14}],18:[function(require,module,exports){
/**
 * API de usuarios
...
exports.Usuario = exports.UsuarioService = undefined;
...
var urlUsuarios = "http://localhost:8080/gestiongimnasio/api/usuarios";

//Clase publica que extiende de GenericService

var UsuarioService = exports.UsuarioService = function (_service$GenericServi) {
    _inherits(UsuarioService, _service$GenericServi);

    function UsuarioService() {
        _classCallCheck(this, UsuarioService);

        return _possibleConstructorReturn(this, (UsuarioService.__proto__ || Object.getPrototypeOf(UsuarioService)).call(this));
    }
    ...
    _createClass(UsuarioService, [{
        ...
        value: function getAll() {
            //Devolvemos una promesa para recoger los datos y no perderlos
            return _get(UsuarioService.prototype.__proto__ || Object.getPrototypeOf(UsuarioService.prototype), "ajax", this).call(this, urlUsuarios, "get", null);
        }
    }, {
        key: "getById",
        value: function getById(codigo) {
            //Devolvemos una promesa para recoger los datos y no perderlos
            return _get(UsuarioService.prototype.__proto__ || Object.getPrototypeOf(UsuarioService.prototype), "ajax", this).call(this, urlUsuarios + "/" + codigo, "get", null);
        }
    }]);
...
function rederizarFormulario() {
    ...
    var us = new UsuarioService();
    var usuario = new Usuario();
    var txt = "";
    return new Promise(function (resolve, reject) {
        if (codigo > -1) {
            us.getById(codigo).then(function (usu) {
                txt = parseForm(usu);
                resolve(txt);
            }).catch(function () {
                reject("No se han podido acceder a los datos del codigo " + codigo);
...
function parseForm(usuario) {
    ...
    txt = "<input type='text' name='nombre'" + " id='nombre' value='" + usuario.nombre() + "'>";
    txt += "</form>";
    return txt;
}
...
function parseUsuario(usuario) {
    ...
    var texto = "<tr>" + "<td><input type='checkbox' value='" + codigo + "'></td>" + "<td>" + nombre + "</td>" + "<td>" + apellidos + "</td>" + "<td>" + user + "</td>" + "<td>" + pass + "</td>" + "<td>" + email + "</td>" + "<td>" + activo + "</td>" + "<td>" + htmlEdit + htmlDelete + "</td>" + "</tr>";
...
},{"./genericservice":16,"jquery":14}],19:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.validarFormularioContacto = validarFormularioContacto;
exports.validarActividad = validarActividad;
exports.validarGrupoMuscular = validarGrupoMuscular;
exports.validarMaquina = validarMaquina;
